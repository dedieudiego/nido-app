...
.bg-gris-oscuro {background-color:#00D7A2; }
        ...
        .link-gris-oscuro:hover {
            color: #838383;
            text-decoration: none;
        }

        .link-gris-oscuro:active {
            color: #4f4f4f;
            text-decoration: none;
        }
    </style>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="p20">
                                    ...
                                    <P class="font14 pt10">Se recibió un nuevo reporte desde la HorneroApp:</P>
                                </td>
                            </tr>
                            <tr>
                                <td class="p20 pt0">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td align="left"><span class="font14">Mensaje:
                                                        <strong>{{ $form->message }}</strong></span></td>
                                            </tr>
                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td align="center">
                                                    <p class="white font14">© 2024 HorneroApp - Enviado desde App Mobile
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="spacer20"></tr>
