			...
			<tbody>
				...
				<tr>
				  <td class="p20">
                        ...
                        <P class="font14 pt10">¡Hola equipo!</P>
                        <P class="font14 pt10">Han recibido un nuevo reporte para su revisión desde la app de GeoVin.</P>
                        <P class="font14 pt10">Estos son los datos enviados por el usuario:</P>
				  </td>
				</tr>
				<tr>
				    <td class="p20 pt0">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td align="left"><span class="font14">Nombre del usuario: {{ $form->message->usuario->name }}</span></td>
                                </tr>
                                <tr>
                                    <td align="left"><span class="font14">Email: {{ $form->message->usuario->email }}</span></td>
                                </tr>
                                <tr>
                                    @php
                                ...
                                <tr>
                                    <td align="left"><span class="font14">Hábitat: {{ $form->message->habitat->name }}</span></td>
                                </tr>
                                <tr>
                                    <td align="left"><span class="font14">Lugar: {{ $form->message->lugar->name }}</span></td>
                                </tr>
                                <tr>
                                    <td align="left">
                                        <span class="font14">Coordenadas: https://www.google.com.ar/maps/{{ '@'.$form->message->gpslat.','.$form->message->gpslng.'z' }}</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                @php
                                    $foto_arriba = file_get_contents($form->message->path_foto_arriba);
                                    $foto_abajo = file_get_contents($form->message->path_foto_abajo);
                                    $arriba = $form->message->foto_arriba;
                                    $abajo = $form->message->foto_abajo;
                                @endphp
                                <tr>
                                    <td align="right">
                                        <img id="foto1" src="{{ $message->embedData($foto_arriba, $arriba ) }}"
                                            style="border-radius: 10px; padding: 10px;" width="90px" height="90px"/>
                                    </td>
                                    <td align="left">
                                        <img id="foto2" src="{{ $message->embedData($foto_abajo, $abajo) }}"
                                            style="border-radius: 10px; padding: 10px;" width="90px" height="90px"/>
                                    </td>
                                </tr>
                            </tbody>
